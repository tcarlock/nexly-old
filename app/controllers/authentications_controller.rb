class AuthenticationsController < ApplicationController
  ...
  def failure
    redirect_to settings_business_path(current_user.business), :notice => "Something went wrong this website was not enabled."    
  end
  ...
  def destroy
    ...
    redirect_to settings_business_path(current_user.business), :notice => "#{platform.display_name} is now disabled"
  end
end
